...
while True:
    ...
    if opcion == "1":
        ...
        print(
            "Esta aplicación es un gestor de notas con el objetivo de organizar y almacenar información, como apuntes o tareas de manera digital. Facilita la gestión y el acceso rápido a la información, ayudando a los usuarios a mantenerse organizados y tener un mejor seguimiento de sus actividades."
        )
    else:
